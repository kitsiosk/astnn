...
class Pipeline:
    ...
    def dictionary_and_embedding(self, input_file, size):
        ...
        if not os.path.exists(data_path+'all/embedding'):
            os.mkdir(data_path+'all/embedding')
        if self.language == 'c':
            sys.path.append('../')
        ...
        w2v.save(data_path+'all/embedding/node_w2v_' + str(size))
    ...
    def generate_block_seqs(self):
        ...
        word2vec = Word2Vec.load(
            self.root + '/'+ self.language+'/all/embedding/node_w2v_' +
            str(self.size)
        ).wv
    ...
    def run(self):
        ...
        # )
        input_file = (
            'programs.pkl' if self.language == 'c' else 'bcb_funcs_all_1vsRest.pickle'
        )
        ...
        if self.language == 'c':
            ...
            self.read_pairs('bcb_pair_ids_1vsRest.pickle')

        # print('split data...')
        # self.split_data()
        path_all = self.root+'/'+self.language+'/all/'
